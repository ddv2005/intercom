export PJDIR := /projects/intercom/3rdparty/pjproject
...
export CC_NAME := gcc
export TARGET_NAME := arm-pc-linux-gnu
export CROSS_COMPILE := arm-pc-linux-
...
export APP_CC := /opt/gcc-rhf/bin/arm-unknown-linux-gnueabi-gcc
export APP_CXX := /opt/gcc-rhf/bin/arm-unknown-linux-gnueabi-g++
export APP_CFLAGS := -DPJ_AUTOCONF=1\
	-O3 -fomit-frame-pointer -mfloat-abi=hard -march=armv6j -mtune=arm1176jzf-s -mfpu=vfp -ftree-vectorize -ffast-math -fmessage-length=0 -fdata-sections -ffunction-sections -marm -DPJ_IS_BIG_ENDIAN=0 -DPJ_IS_LITTLE_ENDIAN=1\
...
export PJ_INSTALL_CFLAGS := -I$(PJ_INSTALL_INC_DIR) -DPJ_AUTOCONF=1	-O3 -fomit-frame-pointer -mfloat-abi=hard -march=armv6j -mtune=arm1176jzf-s -mfpu=vfp -ftree-vectorize -ffast-math -fmessage-length=0 -fdata-sections -ffunction-sections -marm -DPJ_IS_BIG_ENDIAN=0 -DPJ_IS_LITTLE_ENDIAN=1
